...
tag="DPTNet_wsj0-2mix_sep_clean_8gpu_pretrained"  # Controls the directory name associated to the experiment
...
loadpth=exp/train_dptnet_DPTNet_Libri2Mix_enh_single/_ckpt_epoch_193.ckpt
