...
# Example usage
# CUDA_VISIBLE_DEVICES=0 ./run.sh --load_path pretrained/ConvTasNet_Libri1Mix_enhsingle/model.pth
...
if [[ -z ${load_path} ]] || [[ ! -f ${load_path} ]]; then
  echo "Please fill in the pretrained checkpoint path (\$load_path)."
fi
